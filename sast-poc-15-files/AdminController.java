...
public class AdminController {
 ...
 Connection c=DriverManager.getConnection("jdbc:h2:mem:test","sa",""); // Agentic Rule (ARNIE_INPUT_PREPARED_STATEMENTS): Bind untrusted input as a query parameter rather than concatenating it into SQL | Agent: Arnica
